...
static void segment_ui_print_logo(){
...
static void segment_ui_print_wait_for_input(){

	printf("> enter : ");
}

void segment_ui_print_launch_view(){

	segment_ui_print_logo();
	printf("Choose the different types of virtual memory\n");
	printf("---------------------------------------------------\n");
	printf("| 1(Page) | 2(Segment) | 3(SegmentPage) | 4(Quit) |\n");
	printf("---------------------------------------------------\n");
	segment_ui_print_wait_for_input();
}

void segment_ui_print_quit_view(){
...
// 打印出菜单
void segment_ui_print_vm_menu_view(){
...
// 打印出操作成功视图
void segment_ui_print_operate_success(){
...
// 打印出错误视图
void segment_ui_print_error_view(char *msg){
